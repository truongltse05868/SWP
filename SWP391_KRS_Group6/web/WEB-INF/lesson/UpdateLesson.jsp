...
<html lang="en">
    ...
    <head>
        ...
        <!-- PAGE TITLE HERE ============================================= -->
        <title>EduChamp : Update Lesson </title>
        ...
        <script>
            function sendPostRequestLessonList(action) {
                // Tạo form ẩn
        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title">Update Lesson</h4>
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <form class="edit-profile m-b30" action="${pageContext.request.contextPath}/LessonController" method="post">
                                    ...
                                    <input type="hidden" name="lessonId" value="${lessons.lesson_id}"> 
                                    <div class="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <input class="form-control" name="lessonName" type="text" value="${lessons.title}">
                                            ...
                                            <div class="col-sm-2">
                                                <select class="form-control" name="subjectId">
                                                    <c:forEach var="subject" items="${subject}">
                                                        <option value="${subject.subject_id}"<c:if test="${subject.subject_id == lessons.subject_id}">selected</c:if>>${subject.subject_name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
