<%-- 
    ...
    Created on : Jun 18, 2024, 11:17:53 AM
    Author     : HuyPC
--%>
                    ...
                    <div class="section-area section-sp1">
                        <div class="container">
                            <div class="row d-flex flex-row-reverse">
                                ...
                                <%
                                                                      Subject s = (Subject) request.getAttribute("subjectList");
                                %>
                                <div class="col-lg-9 col-md-8 col-sm-12">

                                    <div class="courses-post">
                                        <div class="ttr-post-media media-effect">
                                            <a href="#"><img src="assets/images/courses/pic<%=s.getSubject_id()%>.jpg" alt=""></a>
                                        </div>
                                        <div class="ttr-post-info">
                                            <div class="ttr-post-title ">
                                                <h2 class="post-title"><%=s.getSubject_name()%></h2>
                                            </div>
                                            <div class="ttr-post-text">
                                                <p><%=s.getSubject_code()%></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="courese-overview" id="overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-8"><%=s.getDescription()%></div>
                                        </div>
                                    </div>
