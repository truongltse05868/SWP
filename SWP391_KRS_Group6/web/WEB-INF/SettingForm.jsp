                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <form class="edit-profile m-b30" action="SettingController">
                                    ...
                                    <div class="">
                                        <div class="form-group row">
                                            <div class="col-sm-10  ml-auto">
                                                <h3>1. Setting Details</h3>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">ID</label>
                                            <div class="col-sm-7">
                                                <input class="form-control" readonly name="setting_id" type="text" value="<%=s.getSettingId()%>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Setting Name:</label>
                                            <div class="col-sm-7">
                                                <input class="form-control"  name="setting_name" type="text" value="<%=s.getSettingName()%>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
